...
U8 si446x_configuration_init(const U8* pSetPropCmd)
{
  ...
  while (*pSetPropCmd != 0x00)
  {
    ...
    {
      /* Timeout occured */
	  printf("SI446X_CTS_TIMEOUT occurred\r\n");
 ...
 */
void si446x_start_tx(U8 CHAN, U8 CONDITION, U16 TX_LEN)
{
 ...
 */
void si446x_start_rx(U8 CHAN, U8 CONDITION, U16 RX_LEN, U8 NEXT_STATE1, U8 NEXT_STATE2, U8 NEXT_STATE3)
{
...
void si446x_set_property1( U8 GROUP, U8 NUM_PROPS, U8 START_PROP, U8 argv )
{
    //va_list argList;
    U8 cmdIndex;
    ...
    //while(NUM_PROPS--)
    {
        Pro2Cmd[cmdIndex] = argv/*va_arg (argList, U8)*/;
        cmdIndex++;
    }
    //va_end(argList);
