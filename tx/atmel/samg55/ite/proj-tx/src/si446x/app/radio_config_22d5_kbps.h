...
// MOD_type: 3    Rsymb(sps): 22500    Fdev(Hz): 20000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 902.75    API_TC: 29    fhst: 500000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0
//
// # RX IF frequency is  -500000 Hz
// # WB filter 3 (BW =  98.79 kHz);  NB-filter 7 (BW = 64.52 kHz)
//
// Modulation index: 1.778
*/
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x01, 0x01, 0x17, 0x16, 0x00, 0x00, 0x00
...
*/
#define RF_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x41, 0x00, 0x00
...
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x07, 0x00, 0x00/*0x84 crc confg*/, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x80 /*tx/rx field split, crucial, liyenho*/
...
*/ // liyenho modified...
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x08, \
																					0x00, 0x00, 0x00, \
																					PKT_TX_THRESHOLD, \
																					PKT_RX_THRESHOLD, \
																					0x00, 0x20, \
																					0x04/*PN start continued*/, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_FIELD_3_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, RADIO_PKT_LEN/*rx field len*/, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x0D, 0xBB, 0xA0, 0x05, 0xE8, 0x48, 0x00, 0x00, 0x02
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x01, 0x00, 0x08, 0x03, 0xC0, 0x00, 0x20, 0x20, 0x00, 0xE8, 0x00, 0xB2
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x02, 0xE1, 0x48, 0x00, 0xCF, 0x02, 0x00, 0x00, 0x00, 0x12, 0xC0, 0x0C
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x1D, 0x59, 0xE0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x27, 0x27, 0x80, 0x1A, 0x71, 0xC7, 0x00, 0x29, 0x0C, 0xA4, 0x23
...
*/ // liyenho modified
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x00, 0xD0, 0x0A/*0x05, ant wait time, reduced*/, 0x86/*ant div is on*/, 0xFF, 0x0F, 0x2A, 0x18, 0x15/*0x40: 0x15 reflected actual measurement*/
...
*/
#define RF_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x05, 0x07, 0x78, 0x20
...
*/
#define RF_PA_MODE_5 0x11, 0x22, 0x05, 0x00, 0x88, 0x7F, 0x00, 0x1D, 0x80
...
#define RADIO_CONFIGURATION_DATA_915{ \
                            ...
                            .Radio_ConfigurationArray = RADIO_CONFIGURATION_DATA_ARRAY/*_915*/,                            \
                            }
...
#define RADIO_CONFIGURATION_DATA_869{ \
	...
	.Radio_State_After_Power_Up = RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP,       \
	.Radio_Delay_Cnt_After_Reset = RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET,       \
	.Radio_ConfigurationArray = RADIO_CONFIGURATION_DATA_ARRAY/*_869*/,                            \
}
