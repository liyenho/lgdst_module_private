...
#else
// YH: add local platform here
/* RF related bit fields */
//#define SBIT(name, addr, bit)  volatile unsigned char  name
//SBIT(RF_NSEL,   SFR_P1, 0);
//SBIT(RF_IRQ,    SFR_P1, 0);  //YH: not used
//SBIT(RF_NIRQ,   SFR_P1, 0);
//SBIT(RF_PWRDN,  SFR_P1, B_P1_RF_PWRDN); //YH: not used
//SBIT(PWRDN,  SFR_P1, 0);
