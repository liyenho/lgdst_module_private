#include <compiler.h>  // perhaps such crazy way can help??? liyenho
...
#else
//#warning YH: Using default compiler in compiler_defs.h
...
#define b2 2
#define b3 3
#if 0  // to be defined all in compiler.h?
typedef unsigned char U8;
#ifdef U16
 #undef U16
#endif
  typedef unsigned int U16;  //YH: conflict resolution
typedef unsigned long U32;
...
typedef signed char S8;
 ...
 #undef S16
#endif
  typedef signed int S16;  //YH: conflict resolution
typedef signed long S32;
#endif
typedef union UU16
{
