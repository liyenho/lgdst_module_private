...
#define true													1
#define false													0
#define print_usage                    puts("lgdst 0 rx bm/Va/[Uc]/ns/s/pair-id/pair-locked/loc-gps/MDst/temp/ctune/calib/calib-qry/hopless fpath [chidx] [bsz] [val0,val1,...], all numbers are in hex");
#define RAED_SETUP	\
...
_read:
	...
	while (1==shmLgdst_proc->active) ;
	  {
		  if (false/*rx*/==work_mode && !strcasecmp(argv[3],"pair-locked")) {
