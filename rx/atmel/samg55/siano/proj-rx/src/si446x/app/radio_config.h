...
#define EXTERNAL_PA			0
#define Si4463_USE_TCXO		0


// INPUT DATA
/*
// Crys_freq(Hz): 32000000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 1    ANT_DIV: 1    PM_pattern: 0
// MOD_type: 3    Rsymb(sps): 40000    Fdev(Hz): 20000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
...
// # WB filter 3 (BW =  98.79 kHz);  NB-filter 3 (BW = 98.79 kHz)
//
// Modulation index: 1
*/
...
*/
#define Si4463_GPIO0	0x01
#define Si4463_GPIO1	0x01
#define RF_GPIO_PIN_CFG 0x13, Si4463_GPIO0, Si4463_GPIO1, 0x20, 0x21, 0x00, 0x00, 0x00
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x0D, 0x14, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_CRC_CONFIG_7 0x11, 0x12, 0x07, 0x00, 0x84, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x80
//#define RF_PKT_CRC_CONFIG_7 0x11, 0x12, 0x07, 0x00, 0x84, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x80 //var length packets
...
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, PKT_TX_THRESHOLD, PKT_RX_THRESHOLD, 0x00, 0x20, 0x04, 0xA2, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_FIELD_2_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x14, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
//#define RF_PKT_FIELD_5_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x20, 0x00, 0x00, 0x02, 0x00, 0x82, 0x00, 0xff, 0x00, 0x0A, 0x00, 0x00, 0x00  //variable length packet
...
#define CW_MODE	0
#if CW_MODE
	#define RF_MODEM_MOD_TYPE_12_915 0x11, 0x20, 0x0C, 0x00, 0x00, 0x00, 0x07, 0x0C, 0x35, 0x00, 0x09, 0xE8, 0x48, 0x00, 0x00, 0x02
	#define RF_MODEM_MOD_TYPE_12_869 0x11, 0x20, 0x0C, 0x00, 0x00, 0x00, 0x07, 0x06, 0x1A, 0x80, 0x05, 0xE8, 0x48, 0x00, 0x00, 0x00
	//the next two lines can be used to generate a modulated wave using pseudo random data
	/*#define RF_MODEM_MOD_TYPE_12_915 0x11, 0x20, 0x0C, 0x00, 0x13, 0x00, 0x07, 0x0C, 0x35, 0x00, 0x09, 0xE8, 0x48, 0x00, 0x00, 0x02
	#define RF_MODEM_MOD_TYPE_12_869 0x11, 0x20, 0x0C, 0x00, 0x13, 0x00, 0x07, 0x06, 0x1A, 0x80, 0x05, 0xE8, 0x48, 0x00, 0x00, 0x00*/
#else
	#define RF_MODEM_MOD_TYPE_12_915 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x0C, 0x35, 0x00, 0x09, 0xE8, 0x48, 0x00, 0x00, 0x02
	#define RF_MODEM_MOD_TYPE_12_869 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x06, 0x1A, 0x80, 0x05, 0xE8, 0x48, 0x00, 0x00, 0x00
#endif
...
*/
#define RF_MODEM_FREQ_DEV_0_1_915 0x11, 0x20, 0x01, 0x0C, 0x8F
#define RF_MODEM_FREQ_DEV_0_1_869 0x11, 0x20, 0x01, 0x0C, 0xA4
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12_915 0x11, 0x20, 0x0C, 0x18, 0x01, 0x00, 0x08, 0x03, 0xC0, 0x00, 0x20, 0x20, 0x00, 0xE8, 0x00, 0x64
#define RF_MODEM_TX_RAMP_DELAY_12_869 0x11, 0x20, 0x0C, 0x18, 0x01, 0x00, 0x08, 0x03, 0xC0, 0x00, 0x20, 0x10, 0x00, 0xE8, 0x01, 0x0B
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12_915 0x11, 0x20, 0x0C, 0x24, 0x05, 0x1E, 0xB8, 0x05, 0x1F, 0x02, 0x00, 0x00, 0x00, 0x12, 0x80, 0xA4
#define RF_MODEM_BCR_NCO_OFFSET_2_12_869 0x11, 0x20, 0x0C, 0x24, 0x01, 0xEB, 0x85, 0x01, 0xEB, 0x02, 0x00, 0x00, 0x00, 0x12, 0x80, 0x29
...
*/
#define RF_MODEM_AFC_LIMITER_1_3_915 0x11, 0x20, 0x03, 0x30, 0x02, 0xA6, 0xA0
#define RF_MODEM_AFC_LIMITER_1_3_869 0x11, 0x20, 0x03, 0x30, 0x07, 0x17, 0xA0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_915 0x11, 0x20, 0x0C, 0x38, 0x11, 0x16, 0x16, 0x80, 0x1A, 0x40, 0x00, 0x00, 0x28, 0x0C, 0xA4, 0x23
#define RF_MODEM_AGC_WINDOW_SIZE_12_869 0x11, 0x20, 0x0C, 0x38, 0x11, 0x3A, 0x3A, 0x80, 0x1A, 0x40, 0x00, 0x00, 0x2A, 0x0C, 0xA4, 0x23
...
//   MODEM_RSSI_CONTROL - Control of the averaging modes and latching time for reporting RSSI value(s). 0x02-> Latch RSSI at Sync Word detect
//   MODEM_RSSI_CONTROL2 - RSSI Jump Detection control.
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
//MODEM_RSSI_COMP value of 0x15 was experimentally determined
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x00, 0xD0, 0x0A, 0x80, 0xFF, 0x06, 0x02, 0x18, 0x15
...
#if EXTERNAL_PA
	#define RF_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x88, 0x7F, 0x00, 0x1D
#else
...
*/
#define RF_FREQ_CONTROL_INTE_8_915 0x11, 0x40, 0x08, 0x00, 0x37, 0x0B, 0x60, 0x00, 0x40, 0x00, 0x20, 0xFF
#define RF_FREQ_CONTROL_INTE_8_869 0x11, 0x40, 0x08, 0x00, 0x35, 0x0A, 0xB3, 0x33, 0x03, 0x33, 0x20, 0xFF
...
#define RADIO_CONFIGURATION_DATA_ARRAY_915 { \
        0x07, RF_POWER_UP, \
        ...
        0x10, RF_MODEM_MOD_TYPE_12_915, \
        0x05, RF_MODEM_FREQ_DEV_0_1_915, \
		0x10, RF_MODEM_TX_RAMP_DELAY_12_915, \
		0x10, RF_MODEM_BCR_NCO_OFFSET_2_12_915, \
		0x07, RF_MODEM_AFC_LIMITER_1_3_915, \
        0x05, RF_MODEM_AGC_CONTROL_1, \
		0x10, RF_MODEM_AGC_WINDOW_SIZE_12_915, \
        ...
        0x0C, RF_FREQ_CONTROL_INTE_8_915, \
        0x00 \
 }
 #define RADIO_CONFIGURATION_DATA_ARRAY_869 { \
        0x07, RF_POWER_UP, \
        0x08, RF_GPIO_PIN_CFG, \
        0x06, RF_GLOBAL_XO_TUNE_2, \
        0x05, RF_GLOBAL_CONFIG_1, \
	 ...
	 0x0A, RF_SYNC_CONFIG_6, \
        ...
        0x0D, RF_PKT_RX_FIELD_3_CRC_CONFIG_9, \
	 0x08, RF_PKT_CRC_SEED_31_24_4, \
	 0x10, RF_MODEM_MOD_TYPE_12_869, \
	 0x05, RF_MODEM_FREQ_DEV_0_1_869, \
	 0x10, RF_MODEM_TX_RAMP_DELAY_12_869, \
	 0x10, RF_MODEM_BCR_NCO_OFFSET_2_12_869, \
	 0x07, RF_MODEM_AFC_LIMITER_1_3_869, \
        0x05, RF_MODEM_AGC_CONTROL_1, \
	 0x10, RF_MODEM_AGC_WINDOW_SIZE_12_869, \
        0x0E, RF_MODEM_RAW_CONTROL_10, \
	 0x06, RF_MODEM_RAW_SEARCH2_2, \
	 0x06, RF_MODEM_SPIKE_DET_2, \
	 0x05, RF_MODEM_RSSI_MUTE_1, \
	 0x09, RF_MODEM_DSA_CTRL1_5, \
        ...
        0x0B, RF_SYNTH_PFDCP_CPFF_7, \
        0x10, RF_MATCH_VALUE_1_12, \
	 0x0C, RF_FREQ_CONTROL_INTE_8_869, \
        0x00 \
 }
#else
...
#ifndef RADIO_CONFIGURATION_DATA_ARRAY_915
...
#define RADIO_CONFIGURATION_DATA_915{ \
                            ...
                            .Radio_ConfigurationArray = RADIO_CONFIGURATION_DATA_ARRAY_915,                            \
                            }

#define RADIO_CONFIGURATION_DATA_869{ \
	.Radio_ChannelNumber = RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER,                   \
	.Radio_PacketLength = RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH,              \
	.Radio_State_After_Power_Up = RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP,       \
	.Radio_Delay_Cnt_After_Reset = RADIO_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET,       \
	.Radio_ConfigurationArray = RADIO_CONFIGURATION_DATA_ARRAY_869,                            \
}
