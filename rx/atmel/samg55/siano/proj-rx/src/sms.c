...
//#define DEBUG_VIDEOPIPE
 ...
 extern volatile uint32_t sms4470_fw_hdr[3+1];
 ...
 extern uint32_t gs_uc_tbuffer[2*I2SC_BUFFER_SIZE/sizeof(int)];
...
extern void usb_write_buf1(void *pb, int size);
 ...
 void download_sms_fw(uint32_t sync, uint8_t *chk )
 {
...
void download_sms_data(uint32_t sync, uint8_t *chk ) // rely on read_sms_response can't fail, liyenho
{
