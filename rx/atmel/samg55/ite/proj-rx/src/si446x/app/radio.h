 ...
 *****************************************************************************/
//#define CTRL_RADIO_ECHO  // radio emulation when rf DOESN'T work yet..., liyenho
...
extern char temp_cap_table[TCTBL_SIZE] ; // lookup table for temp/cap compensation
...
#define RSSI_COMP_OFFSET_1	0x11, 0x20, 0x01, 0x4e, 0x16
...
uint8_t channel_scan_selection;
/*****************************************************************************
